...
class Toolbox {
    ...
    initSolanaCollection(attr: { name: string; dir: string; description: string; programId: PublicKey; account: PublicKey }) {
        this.solanaCollection = new SolanaCollection(attr);
    }
    ...
    async uploadEthereumCollectionNFT() {
        ...
        return await this.fileStorageService.uploadCollection(this.ethereumCollection);
    }
    ...
    async uploadSolanaCollectionNFT() {
        ...
        return await this.fileStorageService.uploadCollection(this.solanaCollection);
    }
